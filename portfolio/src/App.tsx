    ...
    <div className="h-screen w-screen overflow-hidden relative bg-black">
      ...
      <nav className="fixed top-0 w-full z-40 px-4 md:px-8 py-6 flex justify-between items-center text-white bg-transparent animate-wavy-bounce">
        ...
        <div className="hidden md:flex items-center space-x-8">
          ...
          <a href="#services" className="relative group transition-colors duration-300">
            <span className="hover:text-gray-300 transition-colors">Services</span>
            <span className="absolute left-0 -bottom-1 w-0 h-0.5 bg-white transition-all duration-300 group-hover:w-full"></span>
          </a>

          <a href="#team" className="relative group transition-colors duration-300">
            <span className="hover:text-gray-300 transition-colors">Team</span>
            <span className="absolute left-0 -bottom-1 w-0 h-0.5 bg-white transition-all duration-300 group-hover:w-full"></span>
          </a>

          <a href="#contact" className="relative group transition-colors duration-300">
      ...
      <div className={`fixed inset-0 bg-black z-30 transition-transform duration-500 ease-in-out transform ${
        ...
        <div className="flex flex-col items-center justify-center h-full space-y-8 text-white text-2xl animate-fade-in">
          <a href="#home" className="hover:text-gray-300 transition-all duration-300 transform hover:scale-105">Home</a>
          <a href="#" className="hover:text-gray-300 transition-all duration-300 transform hover:scale-105">Projects</a>
          <a href="#services" className="hover:text-gray-300 transition-all duration-300 transform hover:scale-105">Services</a>
          <a href="#team" className="hover:text-gray-300 transition-all duration-300 transform hover:scale-105">Team</a>
          <a href="#contact" className="hover:text-gray-300 transition-all duration-300 transform hover:scale-105">Contact</a>
        </div>
      </div>
      ...
      {/* Home Section Target */}
      <div id="home" className="absolute left-0 top-0 h-full w-full md:w-1/3 flex items-center">
